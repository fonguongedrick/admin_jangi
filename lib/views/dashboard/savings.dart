...
class Savings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Savings',style: TextStyle(fontSize: 32,color: primaryColor),),
        centerTitle: true,
      ),
      body: Container(
             ...
             Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('150,000 XAF',style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w600),),
                      Spacer(),
                      Align(
